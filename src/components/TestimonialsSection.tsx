        ...
        <div className="flex sm:grid sm:grid-cols-3 gap-4 md:gap-8 overflow-x-auto sm:overflow-visible snap-x snap-mandatory no-scrollbar pb-2">
          {testimonials.map((item, index) => (
            <motion.div
              ...
              className="min-w-[88%] sm:min-w-0 shrink-0 snap-start bg-white rounded-3xl p-6 md:p-8 border border-surface-dark relative shadow-xl shadow-brand/5 hover:-translate-y-2 transition-transform duration-300"
            >
