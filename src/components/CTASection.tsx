    ...
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        <motion.div 
          ...
          className="bg-brand rounded-3xl p-7 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-brand/20"
        >
          {/* Decorative Pattern */}
          ...
          <div className="relative z-10 flex flex-col items-center">
            <span className="bg-white/20 px-4 py-1.5 rounded-full text-sm font-bold backdrop-blur-md mb-6 md:mb-8 inline-block">
