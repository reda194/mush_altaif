...
export default function MapSection() {
  return (
    <section className="py-16 md:py-24 bg-surface relative overflow-hidden text-charcoal">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12 gap-6 md:gap-8">
          <div className="max-w-2xl text-center md:text-right">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-3 md:mb-4">أين نتجمع؟</h2>
        ...
        <motion.div
          ...
          className="relative w-full h-[350px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl shadow-brand/10 border border-charcoal/10"
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            <div className="bg-white/90 backdrop-blur-xl p-6 md:p-8 rounded-2xl max-w-sm text-center shadow-xl border border-white/40">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-2">ممشى الردف الجديد</h3>
              <p className="text-charcoal/60 text-sm mb-5 md:mb-6">نقطة التجمع الرئيسية للتدريبات الصباحية كل يوم جمعة في تمام الساعة 6:00 صباحاً.</p>
