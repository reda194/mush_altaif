...
if (typeof window !== 'undefined' && (!SERVICE_ID || !TEMPLATE_ID || !PUBLIC_KEY)) {
  console.warn(
    "[ContactForm] EmailJS env vars missing — ensure NEXT_PUBLIC_EMAILJS_SERVICE_ID, " +
    "NEXT_PUBLIC_EMAILJS_CONTACT_TEMPLATE_ID (or NEXT_PUBLIC_EMAILJS_TEMPLATE_ID), " +
    "and NEXT_PUBLIC_EMAILJS_PUBLIC_KEY are set in your deployment environment."
  );
}
