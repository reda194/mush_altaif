    ...
    <section className="py-24 bg-charcoal text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">أكثر من مجرد رياضة</h2>
          ...
          {benefits.map((benefit) => {
            ...
            return (
              <motion.div 
                key={benefit.id}
                variants={item}
                className="bg-surface/5 border border-white/10 rounded-3xl p-8 hover:bg-surface/10 transition-colors group"
              >
