    ...
    <section className="py-16 md:py-24 bg-charcoal text-white relative">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <motion.div 
          ...
          className="flex md:grid md:grid-cols-3 md:grid-rows-2 gap-4 h-auto md:h-[600px] overflow-x-auto md:overflow-visible snap-x snap-mandatory no-scrollbar pb-2"
        >
          {/* Card 1: Membership (Large) */}
          <motion.div variants={item} className="min-w-[88%] md:min-w-0 shrink-0 snap-start md:col-span-2 md:row-span-1 rounded-3xl p-6 md:p-8 bg-gradient-to-br from-charcoal-light to-charcoal border border-white/5 relative overflow-hidden group">
          ...
          <motion.div variants={item} className="min-w-[88%] md:min-w-0 shrink-0 snap-start md:col-span-1 md:row-span-2 rounded-3xl p-6 md:p-8 bg-surface text-charcoal border border-surface-dark relative overflow-hidden group hover:shadow-2xl hover:shadow-brand/10 transition-all duration-500">
          ...
          {/* Card 3: Events (Small) */}
          <motion.div variants={item} className="min-w-[88%] md:min-w-0 shrink-0 snap-start md:col-span-1 md:row-span-1 rounded-3xl p-6 md:p-8 bg-charcoal-light border border-white/5 relative overflow-hidden group">
          ...
          {/* Card 4: Tracks (Small) */}
          <motion.div variants={item} className="min-w-[88%] md:min-w-0 shrink-0 snap-start md:col-span-1 md:row-span-1 rounded-3xl p-6 md:p-8 bg-brand text-white relative overflow-hidden group">
