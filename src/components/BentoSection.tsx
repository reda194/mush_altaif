...
export default function BentoSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-charcoal text-white relative">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-4">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 md:mb-6">كل ما تحتاجه في مكان واحد</h2>
            <p className="text-base md:text-lg text-white/70">
              نقدم مجموعة متكاملة من الخدمات والبرامج التي تناسب جميع أفراد المجتمع. سواء كنت محترفاً أو مبتدئاً، مكانك بيننا!
            </p>
          </div>
          <button className="mt-2 md:mt-0 flex items-center gap-2 text-brand hover:text-white transition-colors group">
        ...
        <motion.div 
          ...
          className="flex sm:grid sm:grid-cols-3 sm:grid-rows-2 gap-4 h-auto sm:min-h-[560px] overflow-x-auto sm:overflow-visible snap-x snap-mandatory no-scrollbar pb-2"
        >
          {/* Card 1: Membership (Large) */}
          <motion.div variants={item} className="min-w-[88%] sm:min-w-0 shrink-0 snap-start sm:col-span-2 sm:row-span-1 rounded-3xl p-6 md:p-8 bg-gradient-to-br from-charcoal-light to-charcoal border border-white/5 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-2 md:mb-3">عضوية المشاة</h3>
            ...
            <ArrowUpLeft className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white/20 group-hover:text-brand group-hover:scale-110 transition-all duration-300" size={32} />
          </motion.div>

          {/* Card 2: Governance (Tall) */}
          <motion.div variants={item} className="min-w-[88%] sm:min-w-0 shrink-0 snap-start sm:col-span-1 sm:row-span-2 rounded-3xl p-6 md:p-8 bg-surface text-charcoal border border-surface-dark relative overflow-hidden group hover:shadow-2xl hover:shadow-brand/10 transition-all duration-500">
            <div className="flex flex-col h-full">
              <div className="w-14 h-14 bg-charcoal text-white rounded-2xl flex items-center justify-center mb-6 md:mb-8 shadow-lg">
                <ShieldCheck size={28} />
              </div>
              <h3 className="text-2xl md:text-3xl tracking-tight leading-tight font-bold mb-4">
                شفافية<br className="hidden md:block"/>مطلقة<br className="hidden md:block"/>وحوكمة.
              </h3>
              <p className="text-charcoal/70 mb-6 md:mb-8 flex-grow text-sm md:text-base">
                نلتزم بأعلى معايير الحوكمة والشفافية. نتيح لك الاطلاع على تقاريرنا المالية وإنجازاتنا بشكل دوري.
              </p>
              <div className="mt-auto flex items-center justify-between text-brand font-bold border-t border-charcoal/10 pt-4 md:pt-6">
          ...
          {/* Card 3: Events (Small) */}
          <motion.div variants={item} className="min-w-[88%] sm:min-w-0 shrink-0 snap-start sm:col-span-1 sm:row-span-1 rounded-3xl p-6 md:p-8 bg-charcoal-light border border-white/5 relative overflow-hidden group">
          ...
          {/* Card 4: Tracks (Small) */}
          <motion.div variants={item} className="min-w-[88%] sm:min-w-0 shrink-0 snap-start sm:col-span-1 sm:row-span-1 rounded-3xl p-6 md:p-8 bg-brand text-white relative overflow-hidden group">
