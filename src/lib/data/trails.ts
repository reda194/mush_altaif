...
export const walkingTrails: Trail[] = [
  ...
  },
  {
    ...
    difficulty: "سهل",
    description:
      "تنفذ حافظة محافظة الطائف ممشى بطول 3 كلم وعرض 12 مترا في منتزه الردف (جنوبي المحافظة) لمزاولة رياضة المشي. تم اعتماد التصميم وإنشاء ممشى من الانترلوك، ويجري العمل على تطوير المساحات المجاورة من خلال إنشاء مسطحات خضراء ومجاميع ألعاب أطفال.",
